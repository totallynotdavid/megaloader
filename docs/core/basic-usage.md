...
try:
    ...
    print("See supported platforms: https://docs.megaloader.com/plugins/supported-platforms")
...
- [Advanced Usage](/core/advanced-usage) - Batch processing, progress tracking, and more
- [Download Implementation](/core/download-implementation) - Complete download examples
- [API Reference](/core/api-reference) - Detailed API documentation
- [Plugin Options](/plugins/plugin-options) - Platform-specific parameters
