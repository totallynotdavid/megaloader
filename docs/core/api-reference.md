...
- [Basic Usage](/core/basic-usage) - Learn the fundamentals
- [Advanced Usage](/core/advanced-usage) - Advanced patterns
- [Creating Plugins](/plugins/creating-plugins) - Build custom extractors
