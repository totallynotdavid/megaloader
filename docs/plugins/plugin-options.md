...
- [Supported Platforms](./supported-platforms.md) - See which platforms need credentials
- [Creating Plugins](./creating-plugins.md) - Learn how to implement credential handling in custom plugins
