...
## Step-by-Step: Building a Real Plugin
...
- [Plugin Options](./plugin-options.md) - Learn about credential handling patterns
- [Supported Platforms](./supported-platforms.md) - See examples of existing plugins
- [Contributing](../development/contributing.md) - Submit your plugin to the project
